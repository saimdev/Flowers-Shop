    ...
    <div class="container-fluid py-3 px-5">
        ...
        <div class="row my-4">
            <div class="col col-12 text-center">
                <h1 style="font-family: 'Poiret One', cursive !important;" class="fw-bold">Flowers For Your Home</h1>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col col-12 d-flex justify-content-center">
                <div class="card" style="width: 18rem; border:none !important;"><img src="{{asset('/imgs/main1.png')}}" class="card-img-top" style="background: #FEE46C; height:14rem" alt="..."></div>
                <div class="card" style="width: 18rem; border:none !important;"><img src="{{asset('/imgs/main2.jpg')}}" class="card-img-top" style="height:14rem" alt="..."></div>
                <div class="card" style="width: 18rem; border:none !important;"><img src="{{asset('/imgs/main3.jpg')}}" class="card-img-top" style="height:14rem" alt="..."></div>
                <div class="card" style="width: 18rem; border:none !important;"><img src="{{asset('/imgs/main4.jpg')}}" class="card-img-top" style="height:14rem" alt="..."></div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row mt-4 mb-5">
            <div class="col col-12 text-center">
                <h2 class="fw-light" style="font-family: 'Poiret One', cursive !important;">Our Flowers</h2>
            </div>
        </div>
        <div class="row mb-2">
